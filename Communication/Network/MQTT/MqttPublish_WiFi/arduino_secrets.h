...
#define SECRET_MQTT_CLIENT_ID "MY_MQTT_CLIENT_ID1"
#define SECRET_MQTT_USERNAME  "MY_MQTT_USERNAME1"
#define SECRET_MQTT_PASSWORD  "MY_MQTT_PASSWORD1"
#define SECRET_MQTT_TOPIC     "channels/MY_CH_NUM/publish" // set the channel number here
