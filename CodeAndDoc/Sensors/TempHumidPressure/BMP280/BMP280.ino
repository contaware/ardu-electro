...
#define BMP280_USED_CHIPID    0x58  // BMP280 has chip ID 0x58 (library default), BME280 has chip ID 0x60
...
void setup()
{
  ...
  if (!bmp280.begin(BMP280_USED_ADDRESS, BMP280_USED_CHIPID))
  {
  ...
  /*
    ...
    In normal mode it does new measurements periodically.
  */
